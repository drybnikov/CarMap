package com.test.denis.carmap.util;
...
public class BottomSheetBehaviorGoogleMapsLike<V extends View> extends CoordinatorLayout.Behavior<V> {
    ...
    public BottomSheetBehaviorGoogleMapsLike(Context context, AttributeSet attrs ) {
        ...
        if (attrs != null) {
            ...
            mState = a.getInt(R.styleable.CustomBottomSheetBehavior_customDefaultState, STATE_ANCHOR_POINT);
            setPeekHeight(a.getDimensionPixelSize(R.styleable.CustomBottomSheetBehavior_peekHeight, 0));
            setHideable(false);
        }
        a.recycle();
